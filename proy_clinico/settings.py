...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ic81eu1==6a3row$0apcex_-1%ozqnxqzut3pj!@lk*e3x%zxc')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'medicos'),
        'USER': os.getenv('DB_USER', 'postgres'),
        'PASSWORD': os.getenv('DB_PASSWORD', '12345'),
        'HOST': os.getenv('DB_HOST', 'localhost'),
        'PORT': os.getenv('DB_PORT', '5432'),
        'CONN_MAX_AGE': int(os.getenv('DB_CONN_MAX_AGE', 0)),
        'CONN_HEALTH_CHECKS': os.getenv('DB_CONN_HEALTH_CHECKS', 'False').lower() in ['true', '1', 'yes'],
        'OPTIONS': {
            'connect_timeout': 10,
        },
    }
